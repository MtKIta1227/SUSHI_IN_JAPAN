...
class MainWindow(QMainWindow):
    """Spectrometer wavelength-calibration utility (ver 1.3)
    * Multiple calibration points via least‑squares fit
    * Peak detection autowrites table
    * Calibration coeffs can be saved to JSON
    """

    def __init__(self):
        super().__init__()
        self.setWindowTitle("Chromex Calibration – multi-point v1.3")
        self.setFixedSize(460, 820)
...
+
    ...
    def _make_layout(self):
        ...
        splitter.addWidget(self.canvas); splitter.addWidget(bottom)
